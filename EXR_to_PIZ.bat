...
REM       Los archivos convertidos se guardarán en una nueva carpeta con la compresión PIZ aplicada.
...
powershell -ExecutionPolicy Bypass -File "%scriptDir%/LGA_Tools/EXR_to_PIZ.ps1" "%~1"
