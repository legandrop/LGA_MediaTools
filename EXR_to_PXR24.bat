...
REM
REM   EXR_to_PXR24 | Lega | v1.10
REM
REM   Convierte archivos EXR de cualquier compresión a compresión PXR24.
...
powershell -ExecutionPolicy Bypass -File "%scriptDir%/LGA_Tools/EXR_to_PXR24.ps1" "%~1"
