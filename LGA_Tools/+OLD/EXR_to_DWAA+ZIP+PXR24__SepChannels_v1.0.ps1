...
#
#   Convierte archivos EXR de cualquier compresion a archivos EXR por canal, con compresion Pxr24.
...
#       La salida se guarda en una nueva carpeta con los archivos divididos por canal y con la compresión Pxr24 aplicada.
#
#   Lega - 2024
# ______________________________________________________________________________________________________________
...
Write-Host ""
Write-Host "Los archivos convertidos por canal están en subcarpetas dentro de:" -ForegroundColor DarkYellow
