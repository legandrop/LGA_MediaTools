...
# Actualizar el comando FFmpeg con el escalado preciso
$ffmpegArgs = @(
    "-y",
    ...
    [v]split=2[base][overlay];
    [base][overlay]overlay=0:0:enable='not(eq(n,0))'[v2];
    [v2]drawbox=y=0:width=iw:height=ceil((ih-(iw/2.35))/2):color=black@0.5:t=fill:enable='not(eq(n,0))',
